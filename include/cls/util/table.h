 ...
 * @retval CLS_INVALID_ARG   If any size parameter is zero.
 ...
 * @retval CLS_OUT_OF_MEMORY If resizing fails or table is full.
 *
 * ### Example
 * @code
 * int k = 10;
 ...
 *
 * @return CLS_SUCCESS on success.
 * @retval CLS_NULLPTR If in or key is NULL.
 ...
 *
 * @return CLS_SUCCESS on success.
 * @retval CLS_NULLPTR    If out, in, or key is NULL.
 * @retval CLS_INVALID_ARG If key_size is zero.
 *
 * ### Example
 * @code
 * float *vp;
 * table_find((void**)&vp, t, &k);
 * if (vp) *vp = 9.0f;
 * @endcode
 */
 ...
 *
 * @return CLS_SUCCESS on success.
 * @retval CLS_NULLPTR      If out or table is NULL.
 * @retval CLS_OUT_OF_MEMORY If allocation fails.
 *
 * ### Example
 * @code
